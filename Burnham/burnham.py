...
wordcloud = WordCloud(width=2000, height=2000, background_color='black', colormap='PuRd_r', repeat=False, max_font_size=400, min_font_size=20).generate(text)


# colormap= orange , Purples_r , OrRd_r
...
"""
wordcloud.WordCloud(font_path=None, width=400, height=200, 
